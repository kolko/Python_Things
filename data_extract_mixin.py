...
#Пояснение по русски:
#1. Хороший пример красивого и удобночитаемого кода (лол)
#2. Происходит вынос данных за пределы класса, при этом это происходит прозрачно для методов самого этого класса.
#   а эти данные можно хранить отдельно/сериализовать/передавать/итд
